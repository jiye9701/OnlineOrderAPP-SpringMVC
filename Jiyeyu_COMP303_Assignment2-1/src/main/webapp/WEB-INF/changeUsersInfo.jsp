...
<form id="allform" action="changedUsersInfo" method="post">
<br>

<div class="form-group-userNo" style = "margin-left:30px" >
<label for="inputuserId"><strong>User No<br></strong></label><br>
<input style="width:400px; height:20px;" type="text" class="form-control" id="userNo" name="userNo" placeholder= "Match the Number" size="100" required/><br></div>
<br>

<div class="form-group-userId" style = "margin-left:30px" >
<label for="inputuserId"><strong>User ID<br></strong></label><br>
<input style="width:400px; height:20px;" type="text" class="form-control" id="userId" name="userId" placeholder= "Enter the Id" size="100" required/><br></div>
<br>
...
<div style="text-align:center;">
           <button style="font-size:20px; border: solid 2px grey; border-radius: 10px; padding:10px 10px; margin-left: -10px; margin-right: 100px; text-align:center;" type="submit" name="Change Users">Edit</button>
